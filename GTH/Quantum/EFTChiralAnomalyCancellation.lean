...
def standardHypercharges : StandardModelHypercharges where
  Y_QL := (1 / 6 : ℝ)
  Y_uR := (2 / 3 : ℝ)
  Y_dR := - (1 / 3 : ℝ)
  Y_LL := - (1 / 2 : ℝ)
...
def anomalyTrace_SU3_sq_U1 (H : StandardModelHypercharges) : ℝ :=
...
def anomalyTrace_SU2_sq_U1 (H : StandardModelHypercharges) : ℝ :=
  3 * H.Y_QL + H.Y_LL
...
def anomalyTrace_Grav_U1 (H : StandardModelHypercharges) : ℝ :=
...
def anomalyTrace_U1_cubic (H : StandardModelHypercharges) : ℝ :=
